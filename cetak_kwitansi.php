		...
		<div id="detail">
			...
			<table width="100%" cellpadding="2">
				...
				<tr>
					...
					<td class="font-13"><b><?php echo buatRp($tampil['penerimaan']); ?> </b><br>
						<div class="font-10">&nbsp;</div>
				...
				<tr>
					...
					<td class="font-13"><b><?php echo terbilang($tampil['penerimaan']); ?> rupiah</b><br>
						<div class="font-9">&nbsp;</div>
